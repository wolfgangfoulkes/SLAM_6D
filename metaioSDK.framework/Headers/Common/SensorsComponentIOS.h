...
@interface SensorsComponentImpl : NSObject <CLLocationManagerDelegate>
{
    ...
    metaio::stlcompat::Vector<metaio::SensorReading> m_gyroscopeSamples;	//!< Samples of the device rotation
    metaio::stlcompat::Vector<metaio::SensorReading> m_magnetometerSamples; //!< Samples of the magnetometer
    metaio::stlcompat::Vector<metaio::SensorReading> m_accelerometerSamples; //!< Samples of the accelerometer.
