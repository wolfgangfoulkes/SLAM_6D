...
struct METAIO_DLL_API SensorValues
{
	...
	bool hasGravity() const { return gravityTimestamp > 0; } ///< true if gravity timestamp was set
	...
	bool hasHeading() const { return headingTimestamp > 0; } ///< true if heading timestamp was set
	...
	bool hasAttitude() const { return attitudeTimestamp > 0; }	///< true if attitude timestamp was set
