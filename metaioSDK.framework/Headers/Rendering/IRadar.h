...
public:
	 ...
	 * \return true on success
	 */
	virtual bool setBackgroundTexture(const metaio::Path& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setObjectsDefaultTexture(const metaio::Path& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setObjectTexture(IGeometry* geometry, const metaio::Path& texturePath) = 0;
